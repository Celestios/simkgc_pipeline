...
PIPELINE_CONFIG = {
    ...
    "run_stage_1b": False,               # Skipped (Trained)
    "stage_1b_epochs": 5,
    "stage_1b_batch_size": 512,
    "stage_1b_resume": True,
...
def main():
    ...
    clean_cmd = f"python src/data/cleaner.py --inputs data/raw/conceptnet_clean.json data/synthetic/all_triplets_deduped.json --output data/raw/conceptnet_clean.json --min-weight 0.5 --from-hf {HF_REPO}"
    if HF_TOKEN:
        clean_cmd += f" --hf-token {HF_TOKEN}"
